        ...
        return [
            ...
            <div className="summonerContent">
                {isValid ? (
                    ...
                    <p className="presentationSite">MyLOL.GG is a simple way to check your champion mastery progress and help you decide what champion you should go for if you need chests.</p>
                )}
            </div>,
